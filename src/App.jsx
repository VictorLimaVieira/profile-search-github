  ...
  return (
    <div className="page"> 
      ...
      <div className='container'>
        <div className="title">
          <svg height="28" viewBox="0 0 16 16" width="28" fill="white" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='search-row'>
          ...
          />
          <button className="search-btn" onClick={buscarPerfil}>
        ...
        {perfil && (
          <div className='profile-card'>
            <img src={perfil.avatar_url} alt={perfil.login} className="avatar" />
            <div className='profile-info'>
              <span className='profile-name'>{perfil.name || perfil.login}</span>
